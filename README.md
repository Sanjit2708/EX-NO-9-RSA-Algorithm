...
// Function to calculate the modular inverse of e mod phi using the 
...
// Step 4: Compute the decryption key d, the modular inverse of e mod 
phi 
...
printf("\nDecrypted Message:\n"); 
for (int i = 0; i < len; i++) { 
int decrypted = (int)mod_exp(encrypted[i], d, n);  // Decrypt the ASCII 
value using RSA 
...
## Output:
<img width="717" height="291" alt="image" src="https://github.com/user-attachments/assets/a9bfb936-57c6-4bf6-8126-9839cd38bb49" />
